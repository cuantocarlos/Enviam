...
<head>
    ...
    <style>
        /* redondeo y difuminado de los bordes de la imagen pero hay que quitar el elemento img */
        .img-container {
            /* min-width: 300px;
            height: 400px;
            ...
            <nav class="bg-white border-gray-200 dark:bg-gray-900">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        <div class="items-center space-x-6 rtl:space-x-reverse hidden md:flex">
                        ...
                        <ul
                            ...
                            @if (Route::has('login'))
                                ...
                                @else
                                    <li>
                                        <a href="{{ route('login') }}"
                                            class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">{{ __('Log in') }}</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('register') }}"
                                            class="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">{{ __('Register') }}</a>
                                    </li>
                                    {{-- <li>
                                        <a href="#"
        ...
        <main class="grow">
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                    ...
                    <div class="flex flex-col sm:flex-row sm:px-8 md:px-12 lg:px-16 gap-4 md:gap-6 lg:gap-8">
                        <!--image of take picture stairs-->
                        <div class="img-container">
                            <img class="img-blur object-cover max-h-80 sm:max-h-none w-full rounded-xl"
                                src="{{ asset('images/stairs.jpg') }}" alt="Taking a pic of Bucarest stairs">
                        </div>
        ...
        <footer class="bg-white dark:bg-gray-900">
            <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div class="flex items-center justify-between">
                    <a href="https://enviam.es/" class="flex items-center space-x-3 rtl:space-x-reverse">
